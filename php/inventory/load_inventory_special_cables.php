            ...
            while($item = mysqli_fetch_assoc($items_db_data))
            {
                ...
                if($item_data_db_data !== false)
                {
                    while($item_data = mysqli_fetch_assoc($item_data_db_data))
                    {
                        ...
                        echo "<td id='" . $item_data['ItemID'] . "'><button class='edit_special_cable_btn btn btn-primary btn-sm'><i class='bx bx-edit'></i></button></td>";
                        echo "</tr>";
                    }
                }
            }
...
<script src="./js/special_cables.js"></script>

<table id="special_cables_table" class="table table-striped table-hover">
    <thead>
        <tr>
